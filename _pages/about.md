...
<p>
  ...
  and
  <a href="https://xiaohaotian.cc/" target="_blank" rel="noopener">Haotian Xiao</a>et.In collaboration with these scholars,my work has spanned multiple areas, including Optimized computational methods for quantum detuning, rReal‑time dynamic data coordination of full‑condition power units via spatiotemporal redundancy techniques, Data‑driven modeling of industrial processes fault diagnosis, Microstructure–interface heat‑transfer analysis, Human posture detection and action‑recognition algorithms, and Robot simulation control and motion‑planning strategies.
</p>
